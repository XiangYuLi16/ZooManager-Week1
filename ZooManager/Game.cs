...
namespace ZooManager
{
    ...
    {
        static public int numCellsX = 10;
        static public int numCellsY = 10;
        ...
        static public void AddToHolding(string occupantType)
        {
            ...
            if (occupantType == "gardenKeeper") holdingPen.occupant = new GardenKeeper("Stampy");
            if (occupantType == "trap") holdingPen.occupant = new Trap();
            if (occupantType == "flowers") holdingPen.occupant = new Flowers();
            if (occupantType == "rabbit") holdingPen.occupant = new Rabbit();
